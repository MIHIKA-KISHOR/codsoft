...
if __name__ == "__main__":  
    ...
    guiWindow.title("To-Do List Manager -for you")  
    # setting the geometry of the window  
    guiWindow.geometry("500x450+750+250")  
    # disabling the resizable option  
    guiWindow.resizable(0, 0)  
    # setting the background color to #FAEBD7  
    guiWindow.configure(bg = "#90ee90")  
    ...
    header_frame = tk.Frame(guiWindow, bg = "#90ee90")  
    functions_frame = tk.Frame(guiWindow, bg = "#90ee90")  
    listbox_frame = tk.Frame(guiWindow, bg = "#90ee90")  
